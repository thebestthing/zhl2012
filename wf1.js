...
obj.account.permissions.features.fileUpload.value = 1024; // 设置为允许上传照片，单位为 MB，可以根据需要修改
obj.account.permissions.features.imageInput.value = 1024; // 设置为允许上传照片，单位为 MB，可以根据需要修改
